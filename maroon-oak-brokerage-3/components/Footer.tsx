      ...
      <div className="mx-auto max-w-[1200px] px-8">
        <div className="grid grid-cols-1 gap-10 pb-12 md:grid-cols-4">
            ...
            <div className="mt-4 flex gap-2.5">
              {socialLinks.map(({ label, Icon }) => (
                <a
                  ...
                  href="#"
                  aria-label={label}
                  className="flex h-[34px] w-[34px] items-center justify-center rounded-full border border-stone/20 transition-colors hover:border-gold [&_svg]:hover:stroke-gold"
                >
          ...
          <div>
            ...
            <ul className="space-y-3 text-[13.5px]">
              <li><Link href="/personal-insurance" className="hover:text-gold">Personal Insurance</Link></li>
              <li><Link href="/business-insurance" className="hover:text-gold">Business Insurance</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-[13.5px]">
              <li><Link href="/claims" className="hover:text-gold">Claims</Link></li>
        ...
        <div className="flex flex-wrap items-center justify-between gap-2.5 border-t border-stone/10 pt-6 text-xs text-stone/45">
          ...
          <div className="flex flex-wrap gap-5">
            ...
            <a href="#" className="hover:text-gold">Licensing Information</a>
          </div>
        </div>
      </div>
    </footer>
