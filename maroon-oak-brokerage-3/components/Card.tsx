...
export function Card({
  ...
  return (
    <div
      className={`rounded-lg border border-charcoal/10 bg-white p-8 transition-all duration-300 hover:-translate-y-1 hover:border-gold/30 hover:shadow-md ${className}`}
    >
      {icon && (
        <div className="mb-5 flex h-14 w-14 items-center justify-center rounded-full bg-maroon/[0.06]">
          {icon}
        </div>
      )}
