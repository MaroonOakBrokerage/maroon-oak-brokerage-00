        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
          {items.map((item) => (
            <Link
              key={item.href}
              href={item.href}
              className="group flex flex-col rounded-lg border border-charcoal/10 bg-white p-7 transition-all hover:-translate-y-1 hover:border-gold/40 hover:shadow-md"
            >
