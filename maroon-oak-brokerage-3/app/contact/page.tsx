...
import { PhoneIcon, MailIcon, ClockIcon, FacebookIcon, InstagramIcon, LinkedinIcon, GoogleIcon } from "@/components/Icons";
                ...
                <div className="mt-5 flex gap-2.5">
                  {[FacebookIcon, InstagramIcon, LinkedinIcon, GoogleIcon].map((Icon, i) => (
                    <a
                      key={i}
                      href="#"
                      className="flex h-9 w-9 items-center justify-center rounded-full border border-charcoal/10 transition-colors hover:border-maroon hover:bg-maroon [&_svg]:hover:stroke-stone"
                    >
